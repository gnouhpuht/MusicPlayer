...
import com.phuong.musicplayer.controll.MyPhoneStateListener;
import com.phuong.musicplayer.musicmanager.MusicManager;

public class PhoneStateReceiver extends BroadcastReceiver implements AudioManager.OnAudioFocusChangeListener{
    private TelephonyManager telephony;
    private MusicManager musicManager;
    private AudioManager am = null;

    public PhoneStateReceiver(MusicManager musicManager) {
